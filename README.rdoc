...
2) Create a client 
 ...
 # Login to the CobrandLoginService
 > client.login
 ...
 # 6) Create a content service request to get the list of supported sites 
 ...
 # 7) Access the sites list
 > service.sites

 # The sites will be stored an array of hashes with keys :content_service_id and :site_name
 [{:content_service_id=>"566", :site_name=>"1st Advantage Federal Credit Union"}, 
  {:content_service_id=>"3190", :site_name=>"1st Bank - Loan"}, 
  {:content_service_id=>"14938", :site_name=>"1st Bank (MT)"}, 
  {:content_service_id=>"15824", :site_name=>"1st Century Bank"}, 
  {:content_service_id=>"15586", :site_name=>"1st Choice Community FCU"}, 
  {:content_service_id=>"13006", :site_name=>"1st Choice Credit Union"},
  ...
  {:content_service_id=>"14293", :site_name=>"Zions Bank - Business"}] 
